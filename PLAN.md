...
| 0.12.0  | **User invitations** — a role invites *lower* roles by email (admin→any, platform→senior & below, senior→developer); invite carries an **expiring token** (default 1 week, configurable) and the assigned role; the invitee registers via the invite link. |
