...
| 0.3.0   | FastAPI + auth: local accounts, API tokens, **GitHub OAuth sign-in** (session tokens; email must match an existing user), roles, ownership scoping. Remaining: first-run setup wizard, more OAuth providers. |
