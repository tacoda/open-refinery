...
| 0.13.x  | **Experiment-tagged runs** — tag live work/executions with an `experiment_id` so they're isolated from normal metrics and feed an experiment's eval samples automatically; tie experiment outcomes into the debt-audit health scores. (Proper t-test/scipy for small-n too.) |
